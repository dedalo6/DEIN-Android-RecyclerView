...
import com.example.recyclerviewdearitzperez.R


class ColorsAdapter(private val colors: List<com.example.recyclerviewdearitzperez.Color>) : RecyclerView.Adapter<ColorsAdapter.ViewHolder>(){
    ...
    class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bindRow(color: com.example.recyclerviewdearitzperez.Color) {
